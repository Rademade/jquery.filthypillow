...
(function (factory) {
    ...
    Calendar.prototype.removeEvents = function () {
        ...
        this.$left.off("click");
        this.$dates.find(".day-val:has(.fp-cal-date:not(.fp-disabled))").off("click");
    };
    ...
    Calendar.prototype.addEvents = function () {
        ...
        this.$dates.find(".day-val:has(.fp-cal-date:not(.fp-disabled))").on("click", function (e) {
            e.stopPropagation();
            self.onSelectDate($(this).children());
        });
    };
    ...
    Calendar.prototype.onSelectDate = function ($target) {
        var addMonths = parseInt($target.attr("data-add-month"), 10);
    ...
    Calendar.prototype.buildDayLabels = function () {
        ...
        for (var i = 0; i < 7; ++i) {
            ...
            this.$dayLabelTemplate.clone().text(
                labelMaker.day(day).format("ddd")).appendTo(this.$days);
        }
    };
    ...
    Calendar.prototype.buildDates = function () {
        var days = this.date.daysInMonth(),
            ...
            firstWeekDay = dateCalc.date(1).weekday() || 7,
            lastWeekDay = dateCalc.date(days).weekday() || 7,
            i;
        this.$dates.empty();
